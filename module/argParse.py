...
def parseArgs():
    ...
    parser.add_argument("-s", "--delay", dest="delay", required=False, type=int, default=1, help=f"请求延迟 (默认 1s)")
    parser.add_argument("-T", "--Timeout", dest="timeout", required=False, type=int, default=10, help="超时时间 (默认 10s)")
    ...
    parser.add_argument("-m", "--model", dest="model", required=False, type=int, default=1, help=f"选择使用的api接口，默认1")
    return parser
